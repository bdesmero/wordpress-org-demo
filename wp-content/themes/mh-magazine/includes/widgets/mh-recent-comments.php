...
class mh_magazine_recent_comments extends WP_Widget {
    function __construct() {
		parent::__construct(
			...
			array('classname' => 'mh_magazine_recent_comments', 'description' => esc_html__('MH Recent Comments widget to display your recent comments including user avatars.', 'mh-magazine'))
		);
	}
    ...
    function form($instance) {
    	$defaults = array('title' => __('Recent Comments', 'mh-magazine'), 'number' => 5, 'offset' => 0, 'avatar_size' => 48);
		$instance = wp_parse_args($instance, $defaults); ?>
		<p>
