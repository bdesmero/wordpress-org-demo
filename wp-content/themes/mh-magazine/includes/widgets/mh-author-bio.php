...
class mh_magazine_author_bio extends WP_Widget {
    function __construct() {
		parent::__construct(
			...
			array('classname' => 'mh_magazine_author_bio', 'description' => esc_html__('MH Author Bio widget to display author avatar and biographical info.', 'mh-magazine'))
		);
	}
    ...
    function form($instance) {
    	$defaults = array('title' => __('About me', 'mh-magazine'), 'user' => 0);
        $instance = wp_parse_args($instance, $defaults); ?>
		<p>
