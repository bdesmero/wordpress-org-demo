...
class mh_magazine_spotlight extends WP_Widget {
    function __construct() {
		parent::__construct(
			...
			array('classname' => 'mh_magazine_spotlight', 'description' => esc_html__('MH Spotlight / Featured widget for use on homepage template.', 'mh-magazine'))
		);
	}
					...
					<div class="mh-spotlight-thumb">
						<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php
							if (has_post_thumbnail()) {
								...
								if ($instance['image_size'] == 'normal') {
									echo '<img class="mh-image-placeholder" src="' . get_template_directory_uri() . '/images/placeholder-spotlight.png' . '" alt="No Picture" />';
								} else {
    ...
    function form($instance) {
    	$defaults = array('title' => __('In the Spotlight', 'mh-magazine'), 'category' => 0, 'cats' => '', 'tags' => '', 'offset' => 0, 'order' => 'date', 'image_size' => 'normal', 'excerpt_length' => 35, 'excerpt' => 0, 'meta' => 0);
        $instance = wp_parse_args($instance, $defaults); ?>
        <p>
