...
class mh_magazine_tabbed extends WP_Widget {
	function __construct() {
		parent::__construct(
			...
			array('classname' => 'mh_magazine_tabbed', 'description' => esc_html__('MH Tabbed widget showing your latest posts, tags and comments.', 'mh-magazine'))
		);
	}
			...
			<div class="mh-tabbed-widget">
				...
				<div id="tab-<?php echo esc_attr($args['widget_id']); ?>-3" class="mh-tab-content mh-tab-comments"><?php
					...
					if ($comments) {
						...
						_e('No comments found', 'mh-magazine');
					} ?>
				</div>
			</div><?php
