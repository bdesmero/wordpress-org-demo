...
class mh_magazine_carousel extends WP_Widget {
    function __construct() {
		parent::__construct(
			...
			array('classname' => 'mh_magazine_carousel', 'description' => esc_html__('MH Carousel widget for use on homepage template.', 'mh-magazine'))
		);
	}
    function widget($args, $instance) {
		...
		echo $args['before_widget'];
			...
			<div id="<?php echo esc_attr($args['widget_id']); ?>" class="flexslider mh-carousel-widget <?php echo 'mh-carousel-' . esc_attr($instance['carousel_layout']); ?>">
	        	<ul class="slides"><?php
