...
class mh_magazine_nip extends WP_Widget {
    function __construct() {
		parent::__construct(
			...
			array('classname' => 'mh_magazine_nip', 'description' => esc_html__('MH News in Pictures widget to display a gallery of thumbnails linked to the post content.', 'mh-magazine'))
		);
	}
