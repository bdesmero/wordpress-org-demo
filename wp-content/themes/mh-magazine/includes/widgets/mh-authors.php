...
class mh_magazine_authors extends WP_Widget {
    function __construct() {
		parent::__construct(
			...
			array('classname' => 'mh_magazine_authors', 'description' => esc_html__('MH Authors widget to display a list of authors including the number of published posts.', 'mh-magazine'))
		);
	}
    ...
    function form($instance) {
        $defaults = array('title' => __('Authors', 'mh-magazine'), 'authorcount' => 5, 'offset' => 0, 'role' => 0, 'orderby' => 'post_count', 'order' => 'DESC', 'avatar_size' => 48);
        $instance = wp_parse_args($instance, $defaults); ?>
		<p>
