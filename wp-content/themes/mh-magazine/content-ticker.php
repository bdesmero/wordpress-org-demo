...
$args = array('posts_per_page' => $mh_magazine_options['ticker_posts'], 'cat' => $mh_magazine_options['ticker_cats'], 'tag' => $mh_magazine_options['ticker_tags'], 'offset' => $mh_magazine_options['ticker_offset'], 'ignore_sticky_posts' => $mh_magazine_options['ticker_sticky']);
